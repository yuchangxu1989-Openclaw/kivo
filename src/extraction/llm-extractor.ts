...
- 每条知识：{"type":"<6类之一>","title":"≤30字口语化短句，像跟同事聊天时说的话","content":"比标题多一层细节：什么场景下做什么、不做会怎样","why":"为什么值得记住；无法推断则为空字符串","summary":"一句话摘要","confidence":0.0-1.0,"tags":["标签"],"similar_sentences":["泛化表述1","泛化表述2"],"scope":"<5类之一>","temporal_status":"<3类之一>","source_anchor":"对话ID+时间戳+触发句摘要"}
