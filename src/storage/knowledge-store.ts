...
function cloneEntry(entry: KnowledgeEntry): KnowledgeEntry {
  return {
    ...
    sourceRange: entry.sourceRange ? JSON.parse(JSON.stringify(entry.sourceRange)) : undefined,
...
function clonePatch(
  ...
  return {
    ...
    sourceRange: patch.sourceRange ? JSON.parse(JSON.stringify(patch.sourceRange)) : undefined,
