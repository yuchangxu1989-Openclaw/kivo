...
export { IntentRepository, ensureIntentSchema } from './intent-repository.js';
export type { IntentInput, IntentSearchOptions, IntentSearchResult } from './intent-types.js';
