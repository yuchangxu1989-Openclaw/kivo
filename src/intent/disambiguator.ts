...
function scoreEvidence(_input: string, entry: InjectedContextEntry, index: number): number {
  // Score based on vector relevance, confidence, and entry type — no keyword matching.
  let score = entry.relevance * 0.5 + entry.confidence * 0.3;
