...
- title 必须是完整的人话句子，10-25字，具体说清「做什么」或「为什么这样做」。优先保留动作、对象、场景和后果；可以使用必要技术名词（如 LLM、向量检索、流水线、prompt），但不能让技术词单独当标题。
- 禁止 2-6 字的抽象名词短语，禁止缩略语、省略主语、四字成语式标题和 AI 摘要腔。
- 好标题："对话中涉及知识点时自动注入相关上下文"、"提取知识时标题要像人说话一样具体"、"用向量检索代替正则做语义判断"。
- 坏标题："语义禁用规则凑"、"知识对齐策略"、"标题优化"、"抽象边界"。
