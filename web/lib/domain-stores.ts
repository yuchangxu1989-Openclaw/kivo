...
function seedActivity() {
  ...
  const events = [
    ...
    { type: 'knowledge_expired', label: '知识过期', summary: '"服务重启后端口释放"经验被标记为需复核，状态切换为 pending。', href: '/knowledge/ke-010', tags: ['pending', '经验', 'knowledge'], occurredAt: new Date(Date.now() - 3 * 60 * 60 * 1000) },
