...
export interface ActivityEvent {
  id: string;
  /** Monotonic SSE event id used for Last-Event-ID replay. */
  eventId?: string;
  type: string;
  label: string;
  summary: string;
...
export interface ResearchTask {
  ...
  /** Whether user has adopted this report into Wiki (FR-W07 AC3) */
  adopted?: boolean;
  /** Whether marked as important/highlight (FR-W07 AC5) */
  highlighted?: boolean;
}
