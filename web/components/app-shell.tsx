...
const navItems: NavItem[] = [
  ...
  { href: '/intent', label: '意图知识库', icon: Zap },
  { href: '/wiki', label: '领域知识库(LLM Wiki)', icon: Library },
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-white text-slate-900">
      ...
      >
        ...
        <nav className={cn('space-y-0.5 pb-20', sidebarCollapsed ? 'p-2' : 'p-3')}>
          {!sidebarCollapsed && (
            <QuickCreateModal
        ...
        <p className={cn('absolute bottom-3 left-0 right-0 text-center text-[10px] text-slate-400', sidebarCollapsed ? 'p-2' : '')}>v0.1</p>
      </aside>
