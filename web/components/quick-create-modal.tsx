...
type KnowledgeType = 'fact' | 'decision' | 'methodology' | 'experience' | 'meta';
        ...
        <DialogContent>
          ...
          <div className="mt-4 space-y-4">
            <div className="space-y-2">
              <label htmlFor="quick-create-title" className="text-sm font-medium text-slate-700">标题</label>
              <Input
            ...
            <div className="space-y-2">
              <label htmlFor="quick-create-content" className="text-sm font-medium text-slate-700">内容</label>
              <Textarea
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                <label htmlFor="quick-create-domain" className="text-sm font-medium text-slate-700">领域</label>
                <Input
