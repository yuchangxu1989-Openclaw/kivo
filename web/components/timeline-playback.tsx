      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="relative z-10 h-1.5 w-full cursor-pointer appearance-none bg-slate-200 rounded-full
              [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:appearance-none
              [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-slate-950 [&::-webkit-slider-thumb]:              [&::-webkit-slider-thumb]:shadow-md [&::-webkit-slider-thumb]:cursor-grab [&::-webkit-slider-thumb]:active:cursor-grabbing"
            aria-label="时间轴位置"
          />
        </div>
        ...
        <button
          type="button"
          onClick={cycleSpeed}
          className="shrink-0 rounded-md border border-slate-200 bg-white px-2 py-1 text-xs font-medium tabular-nums text-slate-700 transition-colors hover:bg-slate-50"
        >
          {speed}x
        </button>
      </div>
