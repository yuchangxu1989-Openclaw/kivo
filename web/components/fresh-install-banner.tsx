...
export function FreshInstallBanner() {
  ...
  return (
    <section className="rounded-3xl border border-amber-200/80 bg-gradient-to-br from-amber-50/80 via-orange-50/40 to-white px-5 py-4 shadow-sm dark:border-amber-800/50 dark:from-amber-950/30 dark:via-orange-950/20 dark:to-slate-900 sm:px-6">
      <div className="flex items-start gap-3">
        <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-amber-100 text-amber-600 dark:bg-amber-900/50 dark:text-amber-400">
          <Sparkles className="h-5 w-5" />
        </div>
        <div className="min-w-0 flex-1 space-y-3">
          <div className="space-y-1">
            <h2 className="text-base font-semibold text-slate-900 dark:text-white">
              这些是示例数据，帮助你了解 KIVO 的功能
            </h2>
