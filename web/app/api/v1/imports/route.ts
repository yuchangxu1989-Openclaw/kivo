...
export interface ImportCandidate extends SharedImportCandidate {}
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!['md', 'markdown', 'txt', 'text', 'json', 'csv', 'pdf', 'epub'].includes(fileType)) {
      return badRequest('Unsupported file type. Accepted: md, txt, json, csv, pdf, epub');
    }
