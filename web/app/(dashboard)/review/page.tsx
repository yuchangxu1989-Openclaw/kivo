...
const TYPE_COLORS: Record<string, string> = {
  ...
  methodology: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300',
  ...
  intent: 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300',
...
function ReviewCard({
  ...
  return (
    <Card className="border-slate-200/80 bg-white shadow-sm transition-all hover:shadow-md dark:border-slate-700 dark:bg-slate-900">
    ...
    <div className="space-y-6">
      <div className="space-y-1">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">萃取审核</h1>
          {total > 0 && (
