...
export default function DashboardPage() {
  ...
  const reviewWarningCount = summary.health.pendingCount;
  const deprecatedCount = summary.byStatus.deprecated ?? 0;
        ...
        <aside className="space-y-4">
          ...
          <Card className="border-slate-200/80 bg-white/95 shadow-sm dark:border-slate-700 dark:bg-slate-900/95">
            ...
            <CardContent className="space-y-3 text-sm">
              <a href="/kivo/knowledge?status=pending" target="_blank" rel="noopener noreferrer" className="block no-underline">
                <div className="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3 cursor-pointer transition-colors hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700">
                  <span className="text-slate-700 dark:text-slate-300">待复核</span>
                  <span className="font-semibold text-slate-950 dark:text-white">{reviewWarningCount}</span>
                </div>
              </a>
              <a href="/kivo/knowledge?status=deprecated" target="_blank" rel="noopener noreferrer" className="block no-underline">
                <div className="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3 cursor-pointer transition-colors hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700">
                  <span className="text-slate-700 dark:text-slate-300">已过时</span>
                  <span className="font-semibold text-slate-950 dark:text-white">{deprecatedCount}</span>
                </div>
              </a>
