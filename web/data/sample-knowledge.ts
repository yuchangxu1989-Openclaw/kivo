...
export const sampleKnowledgeEntries: LocalKnowledgeEntry[] = [
  {
    ...
    status: 'active',
    confidence: 0.96,
    source: { type: 'system', reference: 'KIVO 通用模板包 / 首次 Onboarding' },
    createdAt: NOW,
    updatedAt: NOW,
    version: 1,
  },
  {
    ...
    status: 'active',
    confidence: 0.92,
    source: { type: 'system', reference: 'KIVO 通用模板包 / 导入方法论' },
    createdAt: NOW,
    updatedAt: NOW,
    version: 1,
  },
  {
    ...
    content:
      '冲突裁决页的核心工作是处理 unresolved 冲突。已经 resolved 的记录应该保留历史，但不占据用户的首屏注意力。这样用户能先把真正阻塞知识库一致性的问题处理完。',
    summary: '冲突页优先呈现 unresolved 冲突，已解决记录只保留历史。',
    domain: 'conflicts',
    status: 'active',
    confidence: 0.89,
    source: { type: 'system', reference: 'KIVO 通用模板包 / 冲突治理' },
    createdAt: NOW,
    updatedAt: NOW,
    version: 1,
  },
  {
    ...
    content:
      '只要用户完成上传文档、导入通用模板或手动创建知识中的任意一个动作，就说明已经走通了第一次知识入库闭环。此时应标记 onboarding 完成，并把用户带到知识列表继续浏览。',
    summary: '任意一次成功入库动作即可结束 onboarding，并跳转到知识列表。',
    domain: 'onboarding',
    status: 'active',
    confidence: 0.97,
    source: { type: 'system', reference: 'KIVO 通用模板包 / 首用闭环规则' },
    createdAt: NOW,
    updatedAt: NOW,
    version: 1,
  },
  {
    ...
    content:
      '用户第一次使用搜索时，最容易命中的查询往往不是宽泛问题，而是规则名称、异常描述或决策标题。给出几个通用查询，可以显著降低首用成本并提升命中率感知。',
    summary: '首轮搜索优先使用规则名、异常描述和决策标题。',
    domain: 'search',
    status: 'active',
    confidence: 0.91,
    source: { type: 'system', reference: 'KIVO 通用模板包 / 搜索实践' },
    createdAt: NOW,
    updatedAt: NOW,
    version: 1,
  },
  {
    ...
    status: 'active',
    confidence: 0.88,
    source: { type: 'system', reference: 'KIVO 通用模板包 / 图谱关系' },
    createdAt: NOW,
    updatedAt: NOW,
    version: 1,
  },
